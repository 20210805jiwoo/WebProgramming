...
<body>
	<center>
		<img src="pr38_image/eclass_title.jpg">
	</center>
	<form name=form1 method="get" action="practice38.jsp">
		<table>
			<tr>
			...
			<tr>
				...
				<input type="image" name="id" src="pr38_image/check.gif" style="vertical-align: middle">
				</td>
			</tr>
			<tr>
				<th>패스워드</th>
