...
<body>
	<center>
		<img src="pr22_image/eclass_title.jpg">
	</center>
	<form name="frm" method = post action=Practice22.jsp>
		<table>
			<tr>
			...
			<tr>
				...
				<input type="image" name="id" src="pr22_image/check.gif" style="vertical-align: middle">
				</td>
			</tr>
			<tr>
				<th>패스워드</th>
